...
class DbConnectionHandler
{
    ...
    /**
     * Returns an array to using it as parameter 
     * for the PDO instance constructor. 
     *
    ...
    private static function parseDbInfo($dbInfoKey)
    {
        if ($dbInfoKey === null) 
        {
            $dbInfo = unserialize(self::DB_INFO);
        ...
        return array($dbInfo['driver'].':host='.$dbInfo['host'].';dbname='.$dbInfo['db'], $dbInfo['usr'], 
            $dbInfo['pwd']);
    }
